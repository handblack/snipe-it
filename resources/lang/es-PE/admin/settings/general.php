...
return [
    ...
    'backups_help'              => 'Crear, descargar, y restaurar backups ',
    'backups_restoring'         => 'Restaurando del Backup',
    'backups_upload'            => 'Subir Backup',
    'backups_path'              => 'Los backup del servidor estan almacenados en <code>:path</code>',
    'backups_restore_warning'   => 'Use the restore button <small><span class="btn btn-xs btn-warning"><i class="text-white fas fa-retweet" aria-hidden="true"></i></span></small> to restore from a previous backup. (This does not currently work with S3 file storage or Docker.<br><br>Your <strong>entire :app_name database and any uploaded files will be completely replaced</strong> by what\'s in the backup file.  ',
    'backups_logged_out'        => 'Todos los usuarios existentes, incluido usted, se cerrarán una vez que se complete la restauración.',
    'backups_large'             => 'Las copias de seguridad muy grandes pueden agotar el tiempo de espera en el intento de restauración y es posible que aún deban ejecutarse a través de la línea de comandos.',
    ...
    'login_help'                => 'LOG de intentos de inicio de sesión',
    ...
    'pwd_secure_complexity_disallow_same_pwd_as_user_fields' => 'La contraseña no puede ser la misma que el nombre, apellido, email o nombre del usuario.',
    'pwd_secure_complexity_letters' => 'Requiere al menos una letra',
    'pwd_secure_complexity_numbers' => 'Requiere al menos un numero',
    'pwd_secure_complexity_symbols' => 'Requiere al menos un simbolo',
    'pwd_secure_complexity_case_diff' => 'Requiere al menos una letra mayuscula y una letra minuscula',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if your XCODE-IT installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    'site_name'                 => 'Nombre del sitio',
    'slack'                     => 'Slack',
    'slack_title'               => 'Configuración Slack',
    'slack_help'                => 'Configuración Slack',
    ...
    'snipe_version'  			=> 'Version de XCODE-IT',
    'support_footer'            => 'Enlaces de Soporte de Pie de Página ',
    'support_footer_help'       => 'Especifica quien ve los enlaces de información de Soporte y Manual de Usuarios de XCODE-IT',
    'version_footer'            => 'Versión en pie de página ',
    'version_footer_help'       => 'Especificar quién ve la versión XCODE-IT y el número de compilación.',
    ...
    'oauth_title' => 'Configuración OAuth API',
    'oauth' => 'OAuth',
    'oauth_help' => 'Configuración Oauth Endpoint',
    'asset_tag_title' => 'Actualizar configuración de etiquetas de activos',
    'barcode_title' => 'Configurar Codigo de Barra',
    'barcodes' => 'Codigo de Barras',
    'barcodes_help_overview' => 'Codigo de Barra &amp; Configuracion del QR',
    'barcodes_help' => 'Esto intentará eliminar los códigos de barras almacenados en caché. Por lo general, esto solo se usaría si la configuración de su código de barras ha cambiado o si su URL de Snipe-IT ha cambiado. Los códigos de barras se volverán a generar la próxima vez que se acceda.',
    'barcodes_spinner' => 'Attempting to delete files...',
    'barcode_delete_cache' => 'Eliminar Cache de Codigo de Barra',
    'branding_title' => 'Update Branding Settings',
    'general_title' => 'Update General Settings',
    'mail_test' => 'Send Test',
    'mail_test_help' => 'This will attempt to send a test mail to :replyto.',
    'filter_by_keyword' => 'Filtrar por modulo de configuración',
    'security' => 'Seguridad',
    'security_title' => 'Configuracion de Seguridad',
    'security_keywords' => 'contraseña, contraseñas, requirements, two factor, two-factor, common passwords, remote login, logout, authentication',
    'security_help' => 'Doble-factor, Restriccion de contraseñas',
    'groups_keywords' => 'permissions, permission groups, authorization',
    'groups_help' => 'Grupos de permisos de cuenta',
    'localization' => 'Localization',
    'localization_title' => 'Actualizar configuración de localización',
    'localization_keywords' => 'localization, currency, local, locale, time zone, timezone, international, internatinalization, language, languages, translation',
    'localization_help' => 'Idioma, mostrar fecha',
    'notifications' => 'Notificaciones',
    'notifications_help' => 'Alerta por Email, Configuracion de auditoria',
    'asset_tags_help' => 'Configuracion de prefijos',
    'labels' => 'Etiquetas',
    'labels_title' => 'Configuracion de Etiquetas',
    'labels_help' => 'Configuraion &amp; Tamaño de etiquetas',
    'purge' => 'Limpiar',
    ...
    'ldap_ad' => 'LDAP/AD',
    'employee_number' => 'Codigo Empleado',
    'create_admin_user' => 'Crear un Usuario ::',
    'create_admin_success' => 'Success! Se agrego un admin!',
    'create_admin_redirect' => 'Click here to go to your app login!',
    'setup_migrations' => 'Migracion de DB ::',
    'setup_no_migrations' => 'No había nada que migrar. Las tablas de su base de datos ya estaban configuradas!',
    'setup_successful_migrations' => 'Las tablas de la base de datos a sido creados',
    'setup_migration_output' => 'Migration output:',
    'setup_migration_create_user' => 'Next: Crear usuario',
    'ldap_settings_link' => 'Configuracion LDAP',
    'slack_test' => 'Probar <i class="fab fa-slack"></i> integración',
];
